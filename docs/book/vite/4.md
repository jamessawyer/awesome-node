...
``` typescript [vite.config.ts] {14-17}
...
1. [Sass](https://sass-lang.com/documentation/js-api/modules#render)
2. [Less](https://lesscss.org/usage/#less-options)
3. [Stylus](https://stylus-lang.com/docs/js.html)
...
1. [postcss-pxtorem](https://github.com/cuth/postcss-pxtorem)： 用来将 px 转换为 rem 单位，在适配移动端的场景下很常用。
2. [postcss-preset-env](https://github.com/csstools/postcss-preset-env): 通过它，你可以编写最新的 CSS 语法，不用担心兼容性问题。
3. [cssnano](https://github.com/cssnano/cssnano): 主要用来压缩 CSS 代码，跟常规的代码压缩工具不一样，它能做得更加智能，比如提取一些公共样式进行复用、缩短一些常见的属性值等等。
