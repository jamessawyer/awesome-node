...
![success](./imgs/3-2.webp)

紧接着，我们立马去浏览器中打开`http://localhost:3000`页面，你可以看到React界面。
...
![vite dev transform](./imgs/3-5.webp)
